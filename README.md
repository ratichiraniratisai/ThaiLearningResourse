<html lang="th">
  ...
  <body class="bg-gray-50 text-gray-800 font-sans">
    ...
    <script>
      ...
      // --------- ข้อมูลแหล่งเรียนรู้/ท่องเที่ยวตัวอย่างแบบเฉพาะเจาะจง (จริง/คุ้นหู) ----------
      const BASE_ATTRACTIONS = [
        {
          ...
          type: "วัด",
          description:
            "ศูนย์กลางศิลปวัฒนธรรมและประวัติศาสตร์ชาติไทย เหมาะสำหรับบูรณาการสังคมศึกษา ไทย และประวัติศาสตร์",
          subjects: [
      ...
      // --------- fallback เฉพาะจังหวัด/อำเภอกรณีหาไม่เจอ (จริง ๆ จะไม่ค่อยถูกใช้เพราะเราสร้างครบแล้ว) ----------
